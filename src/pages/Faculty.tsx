      ...
      <section className="relative h-[65vh] flex items-center overflow-hidden bg-navy">
        ...
        <div className="container mx-auto px-6 relative z-20">
          <motion.div 
            ...
            className="max-w-4xl"
          >
            <p className="text-royal font-bold uppercase tracking-[0.3em] text-xs mb-4">The Educators</p>
        ...
        <div className="container mx-auto px-6 relative z-10">
           <div className="flex flex-col lg:flex-row items-center justify-between gap-24">
              <div className="max-w-2xl">
                 <p className="text-royal font-bold uppercase tracking-[0.3em] text-xs mb-6">Audit Strong</p>
                 <h2 className="text-4xl md:text-6xl font-bold text-white mb-10 tracking-tight leading-[1.1] uppercase">High <br /><span className="text-royal underline decoration-4 decoration-royal/10">Impact</span> Expertise</h2>
                 <p className="text-lg text-blue-100/40 leading-[1.6] font-normal mb-16 border-l-4 border-royal/10 pl-10">
        ...
        <div className="container mx-auto px-6">
          <div className="bg-navy border border-white/5 rounded-[5rem] md:rounded-[8rem] p-12 lg:p-32 flex flex-col lg:flex-row items-center justify-between gap-16 text-center lg:text-left shadow-2xl relative overflow-hidden group">
            ...
            <div className="relative z-10">
               <p className="text-royal font-bold uppercase tracking-[0.3em] text-xs mb-6">Opportunities</p>
               <h2 className="text-4xl md:text-5xl font-bold text-white mb-10 tracking-tight leading-[1.1] uppercase">Join the <br />Mission</h2>
               <p className="text-lg text-blue-100/40 font-normal max-w-xl border-l-4 border-royal/10 pl-6">
                 "If you're a subject expert with a heart for teaching, our doorstep is open for you."
               </p>
            </div>
            <button className="relative z-10 bg-royal text-primary px-20 py-10 rounded-full font-black uppercase tracking-[0.4em] text-2xl hover:scale-110 transition-all shadow-2xl shadow-royal/40 group/btn">
              Apply Now <ArrowUpRight size={40} className="group-hover/btn:translate-x-3 group-hover/btn:-translate-y-3 transition-transform opacity-30 group-hover/btn:opacity-100" />
            </button>
          </div>
        </div>
      </section>
        ...
        {selectedFaculty && (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-0 m-auto w-full max-w-5xl h-fit bg-navy border border-white/10 rounded-[4rem] overflow-hidden shadow-[0_100px_200px_-50px_rgba(0,0,0,1)] pointer-events-auto z-[210] flex flex-col md:flex-row"
            >
              <button 
                onClick={() => setSelectedFaculty(null)}
              ...
              <div className="flex-1 p-16 md:p-24 flex flex-col justify-center">
                 <div className="inline-block bg-white/5 text-royal px-8 py-3 rounded-full text-sm font-black uppercase tracking-[0.5em] mb-12 border border-white/5 w-fit leading-none">
                   {selectedFaculty.subject}
                 </div>
                 <h2 className="text-5xl md:text-8xl font-black text-white mb-6 tracking-tighter leading-[0.85] uppercase self-baseline">{selectedFaculty.name}</h2>
                 <p className="text-blue-100/40 font-black uppercase tracking-[0.4em] text-sm mb-16 leading-none">{selectedFaculty.role}</p>
                 
                 <div className="grid grid-cols-1 sm:grid-cols-2 gap-16 mb-20 px-4">
                    <div className="flex flex-col gap-4 border-l-4 border-royal/20 pl-8">
                        <p className="text-sm uppercase font-black text-blue-100/20 tracking-[0.4em] leading-none mb-1">Education</p>
                        <p className="text-2xl font-black text-white leading-tight uppercase tabular-nums">{selectedFaculty.edu}</p>
                    </div>
                    <div className="flex flex-col gap-4 border-l-4 border-cta/20 pl-8">
                        <p className="text-sm uppercase font-black text-blue-100/20 tracking-[0.4em] leading-none mb-1">Experience</p>
                        <p className="text-2xl font-black text-white leading-tight uppercase tabular-nums">{selectedFaculty.exp} Teaching</p>
                    </div>
                 </div>
